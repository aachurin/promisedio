...
#define GETTER(name, field, type) R, name, field, type
#define SETTER(name, field, type) W, name, field, type
#define GETSET(name, field, type) RW, name, field, type
#define METHOD(name, func, flag) F, name, func, flag
#define METHODDEF(def) D, def, ~, ~

#define _c2py_getset_func_M(...)
#define _c2py_getset_func_C(...)
#define _c2py_getset_func_F(...)
#define _c2py_getset_func_D(...)
#define _c2py_getset_func_R(pytype, name, field, type)                  \
    static PyObject* pytype##_get_##name(pytype *self, void *closure) { \
        return c2py_from_##type(self->field);                           \
    }
#define _c2py_getset_func_W(pytype, name, field, type)                              \
    static int PyType##_set_##field(pytype *self, PyObject *value, void *closure) { \
        return c2py_to_##type(&(self->field), value);                               \
    }
#define _c2py_getset_func_RW(pytype, name, field, type) \
    _c2py_getset_func_R(pytype, name, field, type)      \
    _c2py_getset_func_W(pytype, name, field, type)

#define _c2py_getset_M(...)
#define _c2py_getset_C(...)
#define _c2py_getset_F(...)
#define _c2py_getset_D(...)
...
#define _c2py_clear_F(...)
#define _c2py_clear_D(...)
...
#define _c2py_member_F(...)
#define _c2py_member_D(...)
...
#define _c2py_isgetset_F(...)
#define _c2py_isgetset_D(...)
#define _c2py_isgetset_R(...) 1
#define _c2py_isgetset_W(...) 1
#define _c2py_isgetset_RW(...) 1

#define _c2py_ismethod_M(...)
#define _c2py_ismethod_C(...)
#define _c2py_ismethod_F(...) 1
#define _c2py_ismethod_D(...) 1
#define _c2py_ismethod_R(...)
#define _c2py_ismethod_W(...)
#define _c2py_ismethod_RW(...)

#define _c2py_method_M(...)
#define _c2py_method_C(...)
#define _c2py_method_F(pytype, name, func, flag) {#name, (PyCFunction) func, flag},
#define _c2py_method_D(pytype, def, ...) def,
#define _c2py_method_R(...)
#define _c2py_method_W(...)
#define _c2py_method_RW(...)


#define _c2py_hasgetset(...) IF_ELSE(HAS_ARGS(__VA_ARGS__))(EVAL(_c2py_map(_c2py_isgetset_, ~, __VA_ARGS__)))()
#define _c2py_hasmethods(...) IF_ELSE(HAS_ARGS(__VA_ARGS__))(EVAL(_c2py_map(_c2py_ismethod, ~, __VA_ARGS__)))()
...
#define _c2py_getsets_decl(pytype, ...) IF_ELSE(_c2py_hasgetset(__VA_ARGS__))(EVAL(_c2py_map(_c2py_getset_func_, pytype, __VA_ARGS__)))()
...
#define _c2py_methods(pytype, ...)                              \
    IF_ELSE(_c2py_hasmethods(__VA_ARGS__))(                     \
        static PyMethodDef pytype##_methods[] = {               \
            EVAL(_c2py_map(_c2py_method_, pytype, __VA_ARGS__)) \
            {NULL}                                              \
        };                                                      \
    )()
...
#define _c2py_impl(pytype, ...)                         \
    _c2py_getsets_decl(pytype, __VA_ARGS__)             \
    _c2py_getsets(pytype, __VA_ARGS__)                  \
    _c2py_methods(pytype, __VA_ARGS__)                  \
    static void                                         \
